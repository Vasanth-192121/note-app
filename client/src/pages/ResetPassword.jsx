...
const ResetPassword = () => {
    ...
    return (
        <div className='bg-no-repeat bg-center bg-cover min-h-screen' ref={containerRef}>
            <Helmet>
                <title>Reset Password | Keeper Notes</title>
                <meta name="description" content="Reset your Keeper Notes account password using the secure token from your email. Access your notes again by creating a new password." />
                <link rel="canonical" href="https://keeper-notes-nu.vercel.app/reset-password" />
            </Helmet>
            <Navbar />
            <div className='
                flex items-center justify-center min-h-[calc(100vh-64px)]
            ...
            '>
                ...
                '>
                    <form onSubmit={handleResetPassword}>
                        <h1 className='text-2xl font-medium mb-7'>Reset Password</h1>
                        {!token && (
                            <p className="text-red-500 text-sm mb-4">
                                No reset token found. Please use the link from your email.
                            </p>
