...
const Home = () => {
  ...
  return (
    <div className='flex flex-col min-h-screen'>
      ...
      <button
        className='w-12 h-12 md:w-16 md:h-16 flex items-center justify-center rounded-2xl bg-primary hover:bg-blue-600 fixed right-10 md:right-10 bottom-20 md:bottom-20'
        onClick={() => {
          setOpenAddEditModel({
            isShown: true,
            type: "add",
